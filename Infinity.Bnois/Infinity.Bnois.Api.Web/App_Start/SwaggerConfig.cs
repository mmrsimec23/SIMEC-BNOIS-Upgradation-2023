                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Infinity.Bnois.Api.Web");

                        string filePath = string.Format(@"{0}\bin\Infinity.Bnois.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory);
                        c.IncludeXmlComments(filePath);
                        filePath = Path.Combine(System.AppContext.BaseDirectory, @"bin\Infinity.Bnois.Api.Web.xml");
                        c.IncludeXmlComments(filePath);
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        // feature entirely.
                        //c.SetValidatorUrl("http://192.168.1.200/validator");
                        //c.DisableValidator();
