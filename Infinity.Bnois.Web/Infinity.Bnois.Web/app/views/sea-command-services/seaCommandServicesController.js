...
(function () {
    ...
    var controllerId = 'seaCommandServicesController';

    angular.module('app').controller(controllerId, seaCommandServicesController);
    seaCommandServicesController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function seaCommandServicesController($stateParams, employeeService,currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
