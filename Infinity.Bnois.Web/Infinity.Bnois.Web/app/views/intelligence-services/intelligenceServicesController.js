...
(function () {
    ...
    var controllerId = 'intelligenceServicesController';

    angular.module('app').controller(controllerId, intelligenceServicesController);
    intelligenceServicesController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function intelligenceServicesController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
