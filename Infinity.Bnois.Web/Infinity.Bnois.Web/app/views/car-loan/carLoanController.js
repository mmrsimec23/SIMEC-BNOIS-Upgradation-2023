...
(function () {
    ...
    var controllerId = 'carLoanController';

    angular.module('app').controller(controllerId, carLoanController);
    carLoanController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function carLoanController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
        vm.carLoanInfos = [];
