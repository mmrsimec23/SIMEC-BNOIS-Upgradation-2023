...
(function () {
    ...
    transferHistoryController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function transferHistoryController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
        vm.permanentTransferHistories = [];
        vm.temporaryTransferHistories = [];
        ...
        function getTemporaryTransfer(transferId) {
            currentStatusService.getTemporaryTransferHistory(transferId).then(function (data) {
                    vm.temporaryTransferHistories = data.result;
