...
(function () {
    ...
    'use strict';
    var controllerId = 'sasbSuitabilityTestsController';
    angular.module('app').controller(controllerId, sasbSuitabilityTestsController);
    sasbSuitabilityTestsController.$inject = ['$state', 'suitabilityTestService', 'notificationService', '$location'];

    function sasbSuitabilityTestsController($state, suitabilityTestService, notificationService, location) {
        ...
        function getDataList() {
            suitabilityTestService.GetSuitabilityTestListByType(2).then(function (data) {
