...
(function () {
    ...
    var controllerId = 'familyPermissionsController';

    angular.module('app').controller(controllerId, familyPermissionsController);
    familyPermissionsController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function familyPermissionsController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
        ...
        function Init() {
            ...
            currentStatusService.GetFamilyPermissions(vm.pNo).then(function (data) {
