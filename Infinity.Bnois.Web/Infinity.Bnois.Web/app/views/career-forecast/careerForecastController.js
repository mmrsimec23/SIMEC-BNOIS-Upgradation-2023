...
(function () {
    ...
    var controllerId = 'careerForecastController';

    angular.module('app').controller(controllerId, careerForecastController);
    careerForecastController.$inject = ['$stateParams','employeeService','currentStatusService' ,'notificationService', '$state'];

    function careerForecastController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
