...
(function () {
    ...
    var controllerId = 'submarineServicesController';

    angular.module('app').controller(controllerId, submarineServicesController);
    submarineServicesController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function submarineServicesController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
