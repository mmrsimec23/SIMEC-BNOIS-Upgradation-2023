...
(function () {
    ...
    var controllerId = 'miscellaneousServicesController';

    angular.module('app').controller(controllerId, miscellaneousServicesController);
    miscellaneousServicesController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function miscellaneousServicesController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
        ...
        function Init() {
            ...
            currentStatusService.getIntelligenceServices(vm.pNo).then(function (data) {
                vm.intelligenceServices = data.result;
            ...
            currentStatusService.getInstructionalServices(vm.pNo).then(function (data) {
                vm.instructionalServices = data.result;
