...
(function () {
    ...
    function interOrganizationServicesController($stateParams, employeeService, currentStatusService, notificationService, $state) {
        ...
        function Init() {
            ...
            currentStatusService.getDeputationServices(vm.pNo).then(function (data) {
                vm.deputationServices = data.result;
            ...
            currentStatusService.getOutsideServices(vm.pNo).then(function (data) {
                vm.outsideServices = data.result;
