...
(function () {
    ...
    var controllerId = 'securityClearanceController';

    angular.module('app').controller(controllerId, securityClearanceController);
    securityClearanceController.$inject = ['$stateParams','employeeService','currentStatusService' ,'notificationService', '$state'];

    function securityClearanceController($stateParams, employeeService, currentStatusService ,notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
        ...
        function Init() {
            ...
            currentStatusService.getSecurityClearance(vm.pNo).then(function (data) {
