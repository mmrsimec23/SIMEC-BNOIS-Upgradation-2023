...
(function () {
    ...
    var controllerId = 'instructionalServicesController';

    angular.module('app').controller(controllerId, instructionalServicesController);
    instructionalServicesController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService', '$state'];

    function instructionalServicesController($stateParams, employeeService,currentStatusService, notificationService, $state) {
        var vm = this;
        vm.pNo = 0;
