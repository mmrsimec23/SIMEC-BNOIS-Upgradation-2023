...
(function () {
    ...
    'use strict';
    var controllerId = 'certificateUploadController';
    angular.module('app').controller(controllerId, certificateUploadController);
    certificateUploadController.$inject = ['$scope', '$state', '$stateParams', 'educationService', 'notificationService', 'OidcManager', 'FileUploader'];

    function certificateUploadController($scope, $state, $stateParams, educationService, notificationService, OidcManager, FileUploader) {
        var vm = this;
        ...
        if ($stateParams.educationId !== undefined && $stateParams.educationId !== null) {
        ...
        var uploader = $scope.uploader = new FileUploader({
            url: educationService.imageUploadUrl(vm.employeeId, vm.educationId),
